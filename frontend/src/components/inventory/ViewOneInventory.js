...
export default function ViewOneInventory() {
    ...
    useEffect(() => {
        async function getDetails() {
            try {
                const result = await (await axios.get(`https://hotel-management-3-t5ay.onrender.com/inventory/${id}`)).data.data
    ...
    async function updateData(e) {
        ...
        try {
            ...
            const data = await (await axios.put(`https://hotel-management-3-t5ay.onrender.com/inventory/${id}`, newDetails)).status
            if (data === 200) {
                SoloAlert.alert({
                    title: "Welcome!",
    ...
    function deleteUser(e) {
        ...
        SoloAlert.confirm({
            ...
            onOk: async function () {
                ...
                try {
                    const result = await (await axios.delete(`https://hotel-management-3-t5ay.onrender.com/inventory/${id}`)).status
                    console.log(result)
